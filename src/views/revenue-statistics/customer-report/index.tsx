...
import useStyles from "./customer-report.styles";
...
const CustomerReport = () => {
  ...
  const columns: GridColDef[] = [
    ...
    {
      field: "phone",
      headerName: "Tổng Bill",
      flex: 1,
    },
    {
      field: "totalAmount",
      headerName: "Tổng lượt khách hàng",
      flex: 1,
      type: "number",
    },
    {
    ...
    {
      field: "totalAmount",
      headerName: "Khách hàng mới",
      flex: 1,
      type: "number",
    },
    {
      field: "totalAmount",
      headerName: "Khách hàng cũ",
      flex: 1,
      type: "number",
    },
    {
      field: "totalAmount",
      headerName: "Khách hàng chưa quay lại",
      flex: 1,
      type: "number",
    },
  ];
    ...
    <Box className={classes.root}>
      <Grid container className={classes.container}>
        <Grid item xs={12} className={classes.contentLabel}>
          <InventoryIcon />
          <AppText600>Báo cáo khách hàng</AppText600>
        </Grid>
