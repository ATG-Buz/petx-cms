...
import useStyles from "./sercivices-products.styles";
    ...
    <Box className={classes.root}>
      <Grid container className={classes.container}>
        <Grid item xs={12} className={classes.contentLabel}>
          <InventoryIcon />
          <AppText600>Dịch vụ hàng hóa</AppText600>
        </Grid>
        ...
        <Grid item xs={12} className={classes.containerBody}>
          <Grid container className={classes.containerContent} spacing={2}>
            ...
            <Grid item container xs={12} spacing={2} alignItems="flex-end">
              ...
              <Grid item xs={2}>
                <TextFieldBooking fullWidth labels="Dịch vụ /Hàng hóa" />
              </Grid>
              <Grid item xs={2}>
                <AppText600>Xem theo nhân viên</AppText600>
